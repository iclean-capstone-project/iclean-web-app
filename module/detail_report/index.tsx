...
import { Button, Card, Col, Form, Image, Input, Row, Select, notification } from 'antd';
...
export function DetailReport(): JSX.Element {
    ...
    const getDataReport = (): Promise<IReport> => getReportById(
    ...
    <div className='detail_report_container'>
      <Card className='detail_report'>
              ...
              return (
                <Col span={item.span}>
                  <div className='report_item'>
                    ...
                    <Input value={item.defaultValue} className='report_item-info'></Input>
                  </div>
                </Col>
              )})}
          </Row>
          ...
          <Row>
            {image.map((item) => (
                <Col span={3}>
                  <Image src={item.src} width={150} height={150} className='img'></Image>
                </Col>
              ))}
          </Row>
      </Card>
